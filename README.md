...
1. Capture: 把原始材料、临时想法、语雀迁移文档和初步提炼内容放入 `00_raw/`。
2. Distill: 从 `00_raw/` 中提炼 claim、概念、风险、反例。
...
- `00_raw/`: 原始层。PDF、网页摘录、书摘、语雀迁移文档、临时想法、交易灵感、初步 claim 卡片。
...
1. 每天把交易想法和盘后观察放到 `00_raw/`。
2. 每周把最重要的 3-5 条观察压缩成 `00_raw/` 中的 claim 卡片。
